...
/**
 * @constant {number} saltLength - Suggested length of salt in Bytes
 * @static
 */
const saltLength = 16;

/**
 * @constant {number} ivLength - Suggested length of initialization vector in Bytes
 * @static
 */
const ivLength = 12;

/**
 * @constant {number} tagLength -Suggested length of tag for gcm mode in bits
 * @static
 */
const tagLength = 128;
...
/**
 * Convert array of bytes to a bitArray.
 * Taken from sjcl/core/codecBytes.js
 * @licence MIT
 * @ignore
 */
